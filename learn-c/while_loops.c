 ...
 * Inside the while loop, you must write two if conditions, which change
 * the flow of the loop in the following manner (without changing the printf command):
 *
 ...
 *
 * ? Notice that if you do not advance the iterator variable i and use the continue derivative,
